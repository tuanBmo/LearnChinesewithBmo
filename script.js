...
// Hàm đọc dữ liệu an toàn (tránh lỗi crash ứng dụng nếu dữ liệu cũ bị hỏng)
...
function checkAuth() {
    ...
    if (!currentUser) {
        ...
        // Kiểm tra an toàn trước khi điền tên (Tránh lỗi làm liệt nút)
        const greetName = document.getElementById('greetName');
        if (greetName) greetName.innerText = currentUser;
...
// Xử lý nút bấm Đăng nhập an toàn
...
// Bắn pháo hoa (Bọc try/catch để chống crash nếu lỗi mạng)
